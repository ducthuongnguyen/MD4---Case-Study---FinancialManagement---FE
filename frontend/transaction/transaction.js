function findAllWallet() {
    $.ajax({
        type: "GET", url: "http://localhost:8080/wallets", success: function (data) {
            let content = `<tr>
                        <th>Wallet</th>
                        <th>Amount</th>
                    </tr>`;
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $.ajax({
                        ...
                        type: 'PUT',
                        url: "http://localhost:8080/wallets/" + idWallet,
                        data: JSON.stringify(pro),
                        success: function () {
...
function update(id) {
    ...
    $.ajax({
        ...
        success: function (transactions) {
            ...
            $.ajax({
                type: "GET",
                url: "http://localhost:8080/categories/" + childCategory,
                    ...
                    $.ajax({
                        ...
                        success: function () {
                            ...
                            $.ajax({
                                ...
                                type: 'PUT',
                                url: "http://localhost:8080/wallets/" + idNew,
                                data: JSON.stringify(pro),
                                success: function () {
                                    findAllTransactionByWallet(idWallet);
                                    findAllWallet(idWallet);
